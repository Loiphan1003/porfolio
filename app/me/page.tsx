...
const Me = () => {
  return (
    <InfoLayout>
      <Reveal>
        <div className='transition-colors ease-in-out delay-150'>
          <div>
            <h1
          ...
          <section>
            <h2
              className="mt-[55px] text-[1.9rem] transition-colors ease-in-out dark:text-dark-fontColorHeading text-light-fontColorHeading font-bold not-italic leading-[35.2px]
              border-b pb-2"
            >
              Tools
            </h2>
           ...
           "
            ...
            <ul
              className="mt-[20px] pl-[24px] flex flex-col space-y-3 transition-colors ease-in-out delay-150
